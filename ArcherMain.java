...
public class ArcherMain {
    public static void main(String[] args) throws IOException{
        ...
        Menu myMenu=new MainMenu(window);
        Menu myOptions=new Options(window);
		...
		//Event event;
			...
			{//zmiany w Menu.h MainMenu cpp i h Options cpp i h
				ptrPresent.Listening(event, window, doo, myCamera);//funkcja juz nic nie zwraca bo przyjmuje referencje do wskaznikow, jezli chce sie przejsc do innego menu to wskanziki zamieniaja sie wartosciami
				event=null;
			}
		//////////////////////////////////////////////////////////////Update
